...
const minimatch_1 = __importDefault(__nccwpck_require__(1953));
...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const filteredDiff = parsedDiff.filter((file) => {
            return !excludePatterns.some((pattern) => { var _a; return minimatch_1.default.minimatch((_a = file.to) !== null && _a !== void 0 ? _a : "", pattern); });
        });
